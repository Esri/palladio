...
function(pld_houdini_dependency_handle_boost TGT)
	if(${Houdini_VERSION_MAJOR} STREQUAL "19")
		...
		target_link_libraries(${TGT} PRIVATE ${HBOOST_FILESYSTEM})
	elseif(${Houdini_VERSION_MAJOR} STREQUAL "18")
		...
		message(FATAL_ERROR "Unsupported Houdini version")
	endif()
endfunction()
...
function(pld_add_dependency_houdini TGT)
	...
	pld_houdini_dependency_handle_boost(${TGT})
endfunction()
