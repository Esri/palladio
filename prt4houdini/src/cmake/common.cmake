...
if(P4H_WINDOWS)
	...
	set(HOUDINI_ROOT "/opt/hfs${HOUDINI_VERSION}" CACHE STRING "Houdini Installation Path")
endif()
if(P4H_WINDOWS)
    set(HOUDINI_DSO_PATH "$ENV{HOMEDRIVE}$ENV{HOMEPATH}/Documents/houdini${HOUDINI_MAJOR_VERSION}.${HOUDINI_MINOR_VERSION}/dso"  CACHE STRING "Houdini DSO Path")
else()
    set(HOUDINI_DSO_PATH "$ENV{HOME}/houdini${HOUDINI_MAJOR_VERSION}.${HOUDINI_MINOR_VERSION}/dso" CACHE STRING "Houdini DSO Path")
endif()
