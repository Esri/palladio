...
function(p4h_add_dependency_houdini TGT)
	...
	elseif(P4H_LINUX)
		...
		find_library(HOUDINI_UI_LIBRARY  HoudiniUI  PATHS ${HOUDINI_LIBRARY_DIR})
		...
		find_library(HOUDINI_UT_LIBRARY  HoudiniUT  PATHS ${HOUDINI_LIBRARY_DIR})
...
if (NOT HOUDINI_DSO_PATH)
	if(P4H_WINDOWS)
		set(HOUDINI_DSO_PATH "$ENV{HOMEDRIVE}$ENV{HOMEPATH}/Documents/houdini${HOUDINI_MAJOR_VERSION}.${HOUDINI_MINOR_VERSION}/custom_pugins")
	else()
		set(HOUDINI_DSO_PATH "$ENV{HOME}/houdini${HOUDINI_MAJOR_VERSION}.${HOUDINI_MINOR_VERSION}/custom_plugins")
	endif()
endif()
